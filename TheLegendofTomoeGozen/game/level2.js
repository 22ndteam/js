class level2 extends Phaser.Scene {
	...
	preload ()
    {
        ...
        var map = this.load.tilemapTiledJSON('Level2', 'assets/Level2.json');
        this.load.spritesheet('tiles1', 'assets/Map2.png', {frameWidth: 64, frameHeight: 64});
 ...
 create ()
    {
		...
		this.bgmSnd = this.sound.add('level2music');
        ...
        var Tiles = map.addTilesetImage('Map2','tiles1')
		...
		this.enemies2.create(enemy06.x, enemy06.y, 'samurai').setScale(1).setCollideWorldBounds(true);
		this.enemies2.create(enemy07.x, enemy07.y, 'samurai').setScale(1).setCollideWorldBounds(true);
		this.enemies2.create(enemy08.x, enemy08.y, 'samurai').setScale(1).setCollideWorldBounds(true);
		this.enemies2.create(enemy09.x, enemy09.y, 'samurai').setScale(1).setCollideWorldBounds(true);
		this.enemies3.create(enemy10.x, enemy10.y, 'samurai').setScale(1).setCollideWorldBounds(true);
		this.enemies3.create(enemy11.x, enemy11.y, 'samurai').setScale(1).setCollideWorldBounds(true);
